...
async function injectScripts(response) {
  ...
  if (!html.includes("task-links.js")) scripts.push(`<script src="task-links.js?v=${APP_VERSION}"></script>`);
...
self.addEventListener("fetch", event => {
  ...
  const isDynamicFile =
    ...
    url.pathname.endsWith("task-links.js") ||
